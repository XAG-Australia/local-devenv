...
?>
<div class="feature-sec buco" style="height: calc(50vh - 80px); padding-top: 20px !important; padding: 0px; background-image: url('http://localhost:8080/wp-content/uploads/2023/07/featured-bg.jpg'); background-attachment: fixed; background-size: cover; background-position: center;">
