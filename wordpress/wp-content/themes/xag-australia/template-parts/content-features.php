...
<div class="feature-sec buco" style="height: 25vh; padding-top: 10px !important; margin-bottom: 10px; padding: 0px; background: #f7f7f7; background-attachment: fixed; background-size: cover; background-position: center;">
    ...
    <h2 class="section-title" style="font-size: 28px; text-align: center; color: #d0d0d0; font-weight: 400 !important; font-family: 'Roboto Condensed', sans-serif; letter-spacing: 0px; margin-bottom: 50 px; margin-top: 0px; width: 1280px; margin-left: auto; margin-right: auto; padding-left: 40px;">XAG Australia specialises in providing aerial, and unmanned ground <b style="color:#c01920; ">drone technology.</b></h2>
      <div class="row" style="width: 100%; margin-left: auto; margin-right: auto;">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12" style="width: 100%; padding-left: 0px !important; ">
          <div class="feature-box feature-box-one feature-box-1" style="width: 420px; background-color: #ffffff !important; max-width: 420px; height: 200px; border-radius: 0px; margin-left: auto; margin-right: auto;">
            <div class="icon" style="background: url('http://localhost:8080/wp-content/uploads/2023/07/icon-1A.png') no-repeat #ffffff; background-size: 100px; background-position: center;  transition: all 0.3s ease-in-out; width: 100px; height: 100px; float: left;"></div>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12" style="width: 100%; padding-left: 0px !important;">
          <div class="feature-box feature-box-one feature-box-3" style="width: 420px; background-color: #ffffff !important; max-width: 420px; height: 200px; border-radius: 0px; margin-left: auto; margin-right: auto;">
            <div class="icon" style="background: url('http://localhost:8080/wp-content/uploads/2023/07/icon-3A.png') no-repeat #ffffff; background-size: 100px; background-position: center; transition: all 0.3s ease-in-out; width: 100px; height: 100px; float: left;"></div>
            <div class="content" style="width: calc(100% - 100px); height: 100px; float: left;">
      ...
      <h2 class="section-title" style="display: none; font-size: 28px; text-align: center; color: #d0d0d0; font-weight: 400 !important; font-family: 'Roboto Condensed', sans-serif; letter-spacing: 0px; margin-bottom: 50 px; margin-top: 0px; width: 1280px; margin-left: auto; margin-right: auto; padding-left: 40px;">XAG Australia specialises in providing aerial, and unmanned ground <b style="color:#c01920; ">drone technology.</b></h2>
    </div>
    </div>
  <div class="feature-sec" style="height: calc(75vh - 180px); width: 1280px; border: 0px !important; margin-left: auto; margin-right: auto; ">
  <h2 class="section-title" style="font-size: 32px; text-align: center; color: #d0d0d0; font-weight: 300 !important; font-family: 'Roboto Condensed', sans-serif; letter-spacing: 12px; margin-bottom: 50px; margin-top: -50px; width: 1280px; margin-left: auto; margin-right: auto;">FEATURED</h2>
