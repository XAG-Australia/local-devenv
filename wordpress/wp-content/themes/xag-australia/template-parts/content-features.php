...
<div class="feature-sec buco" style="height: 35vh; padding-top: 10px !important; margin-bottom: 10px; padding: 0px; background: #f7f7f7; background-attachment: fixed; background-size: cover; background-position: center;">
    ...
    <h2 class="section-title" style="font-size: 32px; text-align: left; color: #d0d0d0; font-weight: 300 !important; font-family: 'Open Sans', sans-serif !important; letter-spacing: 16px; width: 1280px; margin-left: auto; margin-right: auto; margin-top: 50px; margin-bottom: 50px;">WHAT WE DO</h2>
      <div class="row" style="width: 100%; margin-left: auto; margin-right: auto;">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12" style="width: 100%; padding-left: 0px !important; ">
          <div class="feature-box feature-box-one feature-box-1" style="width: 420px; background-color: #f7f7f7 !important; max-width: 420px; height: 200px; border-radius: 0px; margin-left: auto; margin-right: auto; border: solid 4px #d0d0d0;">
            <div class="icon" style="background: url('http://localhost:8080/wp-content/uploads/2023/07/icon-1A.png') no-repeat #f7f7f7; background-size: 90px; background-position: center;  transition: all 0.3s ease-in-out; width: 100px; height: 100px; float: left; border: solid 4px #d0d0d0;">
          </div>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12" style="width: 100%; padding-left: 0px !important;">
          <div class="feature-box feature-box-one feature-box-2" style="width: 420px; background-color: #f7f7f7 !important; max-width: 420px; height: 200px; border-radius: 0px; margin-left: auto; margin-right: auto; border: solid 4px #d0d0d0;">
            <div class="icon" style="background: url('http://localhost:8080/wp-content/uploads/2023/07/icon-2A.png') no-repeat #f7f7f7; background-size: 90px; background-position: center;  transition: all 0.3s ease-in-out; width: 100px; height: 100px; float: left; border: solid 4px #d0d0d0;">
          </div>
            <div class="content" style="width: calc(100% - 100px); height: 100px; float: left;">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12" style="width: 100%; padding-left: 0px !important;">
          <div class="feature-box feature-box-one feature-box-3" style="width: 420px; background-color: #f7f7f7!important; max-width: 420px; height: 200px; border-radius: 0px; margin-left: auto; margin-right: auto; border: solid 4px #d0d0d0;">
            <div class="icon" style="background: url('http://localhost:8080/wp-content/uploads/2023/07/icon-3A.png') no-repeat #f7f7f7; background-size: 90px; background-position: center; transition: all 0.3s ease-in-out; width: 100px; height: 100px; float: left; border: solid 4px #d0d0d0;">
          </div>
            <div class="content" style="width: calc(100% - 100px); height: 100px; float: left;">
