    ...
    <div class="container-fluid" style="width: 1480px; padding-left: 0px; padding-right: 0px;">
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
          <div class="feature-box feature-box-one feature-box-1" style="width: 25vw; background-color: #fafafa !important; max-width: 480px; height: 480px; border-radius: 5px;">
            <div class="icon" style="background: url('http://localhost:8080/wp-content/uploads/2023/07/service-1.png') no-repeat #fafafa; background-size: 140px; background-position: center; margin-bottom: 30px;"></div>
            <div class="content">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
          <div class="feature-box feature-box-one feature-box-2" style="width: 25vw; background-color: #fafafa !important; max-width: 480px; height: 480px; border-radius: 5px;">
            <div class="icon" style="background: url('http://localhost:8080/wp-content/uploads/2023/07/service-2.png') no-repeat #fafafa; background-size: 140px; background-position: center; margin-bottom: 30px;"></div>
            <div class="content">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
          <div class="feature-box feature-box-one feature-box-3" style="width: 25vw; background-color: #fafafa !important; max-width: 480px; height: 480px;  border-radius: 5px; ">
            <div class="icon" style="background: url('http://localhost:8080/wp-content/uploads/2023/07/service-3.png') no-repeat #fafafa; background-size: 140px; background-position: center; margin-bottom: 30px;"></div>
            <div class="content">
