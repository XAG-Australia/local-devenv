...
<div class="feature-sec buco" style="height: 35vh; padding-top: 10px !important; margin-bottom: 10px; padding: 0px; background: #f7f7f7; background-attachment: fixed; background-size: cover; background-position: center;">
    ...
    <h2 class="section-title" style="font-size: 22px; text-align: left; color: #d0d0d0; font-weight: 300 !important; font-family: 'Roboto Condensed', sans-serif; letter-spacing: 4px; margin-bottom: 35px; margin-top: 35px; width: 1280px; margin-left: auto; margin-right: auto;">Pioneering aerial, and unmanned ground <b style="color:#232323;">drone technology.</b></h2>
  ...
  <h2 class="section-title" style="font-size: 32px; text-align: left; color: #d0d0d0; font-weight: 300 !important; font-family: 'Open Sans', sans-serif !important; letter-spacing: 16px; width: 1280px; margin-left: auto; margin-right: auto; margin-top: 50px; margin-bottom: 50px;">FEATURED</h2>
