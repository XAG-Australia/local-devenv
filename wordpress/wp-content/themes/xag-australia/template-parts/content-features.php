    ...
    <div class="container-fluid" style="width: calc(60vw + 150px); padding-left: 0px; padding-right: 0px;">
      <div class="row" style="width: 100%; margin-left: auto; margin-right: auto;">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12" style="max-width: 20vw; ">
          <div class="feature-box feature-box-one feature-box-1" style="width: 20vw; background-color: #ffffff !important; max-width: 480px; height: 460px; border-radius: 20px;  margin-right: 50px;">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12" style="max-width: 20vw;">
          <div class="feature-box feature-box-one feature-box-2" style="width: 20vw; background-color: #ffffff !important; max-width: 480px; height: 460px; border-radius: 20px; margin-right: 50px;">
