...
<div class="feature-sec buco" style="height: 87vh; margin-top: 100px; padding: 0px;">
    ...
    <div class="container-fluid" style="width: calc(60vw + 150px); padding-left: 0px; padding-right: 0px;">
      <div class="row" style="width: 100%; margin-left: auto; margin-right: auto;">
		...
		?> 
        <div class="col-lg-4 col-md-6 col-sm-12" style="max-width: 100%; ">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12" style="max-width: 100%;">
          <div class="feature-box feature-box-one feature-box-2" style="width: 20vw; background-color: #ffffff !important; max-width: 480px; height: 460px; border-radius: 20px; margin-left: 50px;">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12" style="max-width: 100%;">
          <div class="feature-box feature-box-one feature-box-3" style="width: 20vw; background-color: #ffffff !important; max-width: 480px; height: 460px;  border-radius: 20px; margin-left: 50px;">
            ...
            <p style="text-align: left; color: #d0d0d0 !important; margin-top: 40px;">XAG Australia has developed field survey drones that can generate high-resolution and detailed models of difficult to access areas. Our agriculture and farming industry drones allow the quick and safe delivery of field surveying data.</p>
			</div>
  ...
  <div class="feature-sec" style="height: 33.33vw; width: 100vw;">
      ...
      <div class="featured-2" style="height: 33.33vw; width: 33.33%;  float: left; background: url('http://localhost:8080/wp-content/uploads/2023/07/product-2.png') no-repeat rgb(0 0 0 /0.1); background-size: cover; background-position: bottom;">
    
    </div>
      <div class="featured-3" style="height: 33.33vw; width:33.33%;   float: left; background: url('http://localhost:8080/wp-content/uploads/2023/07/product-3.png') no-repeat rgb(0 0 0 /0.1); background-size: cover; background-position: bottom;">
