...
?>
<div class="feature-sec buco" style="height: calc(50vh - 80px); padding-top: 20px !important; padding: 0px; background: #fafafa; background-attachment: fixed; background-size: cover; background-position: center;">
