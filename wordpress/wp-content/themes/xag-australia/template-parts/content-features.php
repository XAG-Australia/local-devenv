...
?>
<div class="feature-sec buco" style="height: 50vh; padding-top: 20px !important; padding: 0px; background-image: url('http://localhost:8080/wp-content/uploads/2023/07/featured-bg.jpg'); background-attachment: fixed; background-size: cover; background-position: center;">
    <h2 class="section-title" style="font-size: 28px; text-align: left; color: #d0d0d0; font-weight: 400 !important; font-family: 'Roboto Condensed', sans-serif; letter-spacing: 0px; margin-bottom: 25px; margin-top: 25px;">XAG Australia specialises in providing aerial, and unmanned ground <b style="color:#c01920; ">drone technology.</b></h2>
