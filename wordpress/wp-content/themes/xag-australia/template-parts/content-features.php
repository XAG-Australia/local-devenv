...
<div class="feature-sec buco" style="height: 35vh; padding-top: 10px !important; margin-bottom: 10px; padding: 0px; background: #f7f7f7; background-attachment: fixed; background-size: cover; background-position: center;">
    ...
    <h2 class="section-title" style="font-size: 24px; text-align: center; color: #4c4c4c; font-weight: 300 !important; font-family: 'Open Sans', sans-serif; letter-spacing: 4px; margin-bottom: 50px; margin-top: 50px; width: 1280px; margin-left: auto; margin-right: auto;">WHAT WE DO<br>Pioneering aerial, and unmanned ground <b style="color:#c01920; ">drone technology.</b></h2>
