...
<div class="feature-sec buco" style="height: 25vh; padding-top: 10px !important; margin-bottom: 10px; padding: 0px; background: #f7f7f7; background-attachment: fixed; background-size: cover; background-position: center;">
  ...
  <h2 class="section-title" style="font-size: 72px; text-align: center; color: #d0d0d0; font-weight: 200 !important; font-family: 'Roboto Condensed', sans-serif; letter-spacing: 6px; margin-bottom: 50px; margin-top: -50px; width: 1280px; margin-left: auto; margin-right: auto;">FEATURED</h2>
