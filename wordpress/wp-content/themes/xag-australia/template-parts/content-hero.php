	...
	<div id="slidr-div" style="display: inline; min-width: 100vw; min-height: calc(50vh + 80px); box-shadow: 3px 3px 40px rgb(0 0 0 / 35%); background: #c01920;">
		...
		<div data-slidr="three" style="min-width: 100vw; min-height: calc(50vh + 80px);">
			...
			; background-position: center; width: 1280px; margin-left: auto; margin-right: auto; padding: 0px !important;">
				<div class="container" style="padding-left: 0px; padding-right: 0px; margin-left: unset; margin-right: unset; width: 30% !important; height: calc(100% - 180px) !important; background: #c01920; border-radius: 0px 160px 160px 0px; max-width: 1280px !important; margin-top: 180px !important;">
					<div class="row">
						<div class="content-sec" style="right: 50px;">
						<img src="http://localhost:8080/wp-content/uploads/2023/07/logo-white-1.png" width="160">
