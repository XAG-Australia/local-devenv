  ...
  <!-- START HERO SLIDER -->
	...
	<div id="slidr-div" style="display: inline; min-width: 100vw; min-height: 50vh; box-shadow: 3px 3px 40px rgb(0 0 0 / 35%); background: #232323;">
		...
		<div data-slidr="one" style="min-width: 100vw; min-height: 50vh;">
			<section class="hero-sec" style="border-left: solid 100px #232323; background-image: url('http://localhost:8080/wp-content/uploads/2023/07/slide-3.jpg'); background-attachment: fixed; background-size: cover; background-position: center; width: 1280px; margin-left: auto; margin-right: auto; padding: 0px !important;">
